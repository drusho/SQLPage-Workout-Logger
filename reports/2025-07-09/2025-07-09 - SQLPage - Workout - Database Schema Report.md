...
| `templateId` | TEXT |  |  |  |  |
| `currentMaxRepsEstimate` | INTEGER |  |  |  |  |
...
CREATE TABLE dimExercisePlan (
    ...
    current1rmEstimate REAL,
    targetSets INTEGER,
    targetReps INTEGER, progressionModelId TEXT REFERENCES dimProgressionModel (progressionModelId), templateId TEXT, currentMaxRepsEstimate INTEGER,
...
| exercisePlanId | userId | exerciseId | templateName | userTemplateAlias | isActive | currentStepNumber | current1rmEstimate | targetSets | targetReps | progressionModelId | templateId | currentMaxRepsEstimate |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| BE0247E2D519FEE6D002CB9EBC161FD2 | davidrusho | UUID005 | Full Body B | NULL | 1 | 1 | 67.0 | NULL | NULL | prog_model_high_reps_uuid | plan_B_uuid | NULL |
| BF533DCF0A7494C5943B1985939A45AA | davidrusho | UUID007 | Full Body B | NULL | 1 | 1 | NULL | NULL | NULL | prog_model_high_reps_uuid | plan_B_uuid | NULL |
| 0C0B406257108852FA618A1FF3963EA4 | davidrusho | UUID008 | Full Body B | NULL | 1 | 1 | NULL | NULL | NULL | prog_model_calisthenics_uuid | plan_B_uuid | 20 |
...
| prog_model_high_reps_uuid | davidrusho | 8 Step RPE High Reps | weight | A weight-based progression model focusing on hypertrophy, moving from 10 to 12 reps. |
| prog_model_low_reps_uuid | davidrusho | 8 Step RPE Low Reps | weight | A weight-based progression model focusing on strength, moving from 6 to 7 reps. |
...
| step_low_reps_1 | prog_model_low_reps_uuid | 1 | 3 sets of 6 reps @ 75% of 1RM | 75.0 | 3 | 6 |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 9aa54afe80e4786f58f71727f73fa7c0 | davidrusho | UUID004 | 20250528 | NULL | 1 | 12 | 40.0 | 8.0 | 1748475461 | 1748475461 | NULL |
| 96029ed67c9413ebae0d6389c94cd6b4 | davidrusho | UUID004 | 20250528 | NULL | 2 | 12 | 40.0 | 8.0 | 1748475461 | 1748475461 | NULL |
| a9ee5163304a3cee181bff8a78f674cc | davidrusho | UUID004 | 20250528 | NULL | 3 | 12 | 40.0 | 8.0 | 1748475461 | 1748475461 | NULL |
...
| Index Name | Columns | Unique |
| :--- | :--- | :--- |
| `sqlite_autoindex_sqlpage_files_1` | `path` | ✅ |
...
| :--- | :--- | :--- |
| sqlpage/templates/modal.handlebars | <div class="modal{{~#if class}} {{class}}{{/if~}}" id="{{id}}" tabindex="-1" aria-hidden="false" aria-labelledby="{{title}}">
