...
│   ├── workouts-backup-2025-07-04_140047.db
│   ├── workouts-backup-2025-07-06_124306.db
│   ├── workouts-backup-2025-07-06_154714.db
│   ├── workouts-backup-2025-07-06_155141.db
│   ├── workouts-backup-2025-07-06_160259.db
│   ├── workouts-backup-2025-07-06_163902.db
│   ├── workouts-backup-2025-07-06_194358.db
│   ├── workouts-backup-2025-07-07_221434.db
│   └── workouts-backup-2025-07-08_192428.db
├── docs
│   ├── App Design & Flow.md
...
│   ├── 013_add_progression_model_tables.sql
│   ├── 014_add_notes_to_history.sql
│   ├── 015_import_progression_models.sql
│   ├── 016_import_migration_progression_models.sql
│   ├── 017_add_template_id.sql
│   ├── 018_separate_workout_templates.sql
│   ├── 019_create_modals_table.sql
│   ├── 020_add_max_reps_estimage.sql
│   ├── README.md
...
│   │   ├── 2025-07-03 - SQLPage - Workout - Folder Tree Report.md
│   │   └── 2025-07-03 - SQLPage - Workout - SQL Comment Documentation.md
│   ├── 2025-07-05
│   │   ├── 2025-07-05 - SQLPage - Workout - Database Schema Report.md
│   │   ├── 2025-07-05 - SQLPage - Workout - Folder Tree Report.md
│   │   └── 2025-07-05 - SQLPage - Workout - SQL Comment Documentation.md
│   ├── 2025-07-06
│   │   ├── 2025-07-06 - SQLPage - Workout - Database Schema Report.md
│   │   ├── 2025-07-06 - SQLPage - Workout - Folder Tree Report.md
│   │   └── 2025-07-06 - SQLPage - Workout - SQL Comment Documentation.md
│   └── 2025-07-09
│       └── 2025-07-09 - SQLPage - Workout - Database Schema Report.md
├── schema
│   ├── README.md
│   ├── _migrations.yml
│   ├── dimDate.yml
│   ├── dimExercise.yml
│   ├── dimExercisePlan.yml
│   ├── dimProgressionModel.yml
│   ├── dimProgressionModelStep.yml
│   ├── dimUser.yml
...
└── www
    ...
    │   └── action_update_progression.sql
    ├── admin
    │   ├── admin_debug_user.sql
    │   └── admin_reset_admin_password.sql
    ├── api
    │   └── api_recent_workouts.sql
    ├── assets
    │   ├── custom_form_layout.css
    │   ├── highlight.js
    │   ├── navigation.json
    ...
    ├── components
    │   └── unplanned_workout_form.sql
    ├── dev
    │   ├── dev_action_save_workout.sql
    │   ├── dev_debug_action_edit_workout.sql
    │   ├── dev_debug_info.sql
